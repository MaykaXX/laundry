...
public:
    ...
    void customers() {
        ...
        std::vector<Customers> customer = {
            ...
            {"👩‍💻 Вера", "Стираю ночью, чтобы не отвлекаться от кода. Надеюсь, соседи поймут..."},
            {"🧙‍♂️ Станислав", "Я зачаровал носки от исчезновения. Теперь проверим, работает ли!"},
            {"🦸‍♀️ Кира", "Мой костюм супергероя нельзя сушить горячим воздухом. Он... сжимается."},
            {"🎭 Роман", "Костюмы для спектакля должны сиять. Как и актёры."},
            {"👨‍🚀 Юрий", "После тренировки в невесомости даже форма пахнет звёздами."},
            {"🧒 Тимур", "Мама велела постирать. Я сам не знаю, что тут делать..."},
            {"👩‍🌾 Дарья", "С грядки — в барабан. Всё как по плану."},
            {"🐶 Боня", "Гав! Принёс одеяло. Оно само пришло в грязь, честно!"},
            {"👨‍🏫 Евгений", "Прежде чем стирать, проведём небольшой инструктаж по ткани."},
            {"👩‍🚒 Катя", "Форма пожарная, но теперь пусть будет просто горячая... от стирки!"}
